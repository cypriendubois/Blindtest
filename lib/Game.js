...
var Game = {
  ...
  checkAnswer: function(user, button) {
    ...
    if (isRight) {
      ...
      user.increase_score(Game.POINT_RIGHT_ANSWER);
      console.log(user.getName() + ' increases their tally by' + Game.POINT_RIGHT_ANSWER)
      user.isRight();
      setTimeout(() => {
        Game.nextSong();
      }, 5000);
      ...
      user.decrease_score(Game.POINT_PENALTY);
      console.log(user.getName() + ' decreases their tally by' + Game.POINT_RIGHT_ANSWER)
